...
function BASS_SFX_PluginRender(handle : HSFX; hStream : HSTREAM; DC : HDC): HBitmap; stdcall; external BASS_SFX_DLL; //only sonique, bassbox, or WMP
...
function BASS_SFX_PluginResizeMove(handle : HSFX; nLeft, nTop, nWidth, nHeight : integer): BOOL; stdcall; external BASS_SFX_DLL;
